...
public class Pending_Activity extends AppCompatActivity {
    ...
    BonafiteCertificateAdapterForPendingAcivity bonafiteCertificateAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityCompat.requestPermissions(Pending_Activity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String s) {
                ...
                BonafiteCertificateAdapterForPendingAcivity adapter = new BonafiteCertificateAdapterForPendingAcivity(Pending_Activity.this,models);
        ...
        fStore.collection("StudentBonafiteCertificateApplicationForm").orderBy("Date", Query.Direction.DESCENDING)
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        bonafiteCertificateAdapter = new BonafiteCertificateAdapterForPendingAcivity(Pending_Activity.this,modelList);
